...
class Ship(Sprite):
    ...
    def __init__(self, ai_game):
        ...
        # Загружаем изображение и меняем размер для жизней
        self.image = pygame.image.load('images/ship.bmp')
        self.image = pygame.transform.scale(self.image, (55, 55))
        self.rect = self.image.get_rect()

        # Загружаем изображение и получаем треугольник
    ...
    def update(self):
        ...
        # Обновляется атрибут х,у а не rect
        ...
        # Обновление атрибута rect на основании х,у
        self.rect.x = self.x
        self.rect.y = self.y
